...
import style from './ListFruitsLegumes.module.css'

function ListFruitsLegumes(props){
    ...
    */
    ...
    return (
        <div>
            <h2 className={style.listCategory}>{itemCategory}</h2>
            <ol className={style.listItems}>{listItems}</ol>
        </div>
    )
}

ListFruitsLegumes.propTypes = {
...
ListFruitsLegumes.defaultProps = {
    category : "Default Category",
    items : []
}

export default ListFruitsLegumes;